...
function Splash() {
  return (
    <div className="grid grid-rows-splash grid-cols-splash">
      ...
      <img className="absolute top-28 right-56 h-64 w-64" src={greenSticky} alt="Green sticky note"></img>
      <img className="absolute top-56 right-1/4 h-64 w-64 z-10" src={yellowSticky} alt="Yellow sticky note"></img>
      <div className="h-screen bg-blue-600">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 ml-auto m-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
